package com.vtcpro.driver.ui.activity.currentride;
...
import com.vtcpro.driver.data.network.model.Provider;
...
import static com.vtcpro.driver.MvpApplication.tripResponse;
...
public class CurrentRideActivity extends BaseActivity {
    ...
    private void showDetail() {
        ...
        try {
            ...
            if (DATUM.getStartedAt() != null) {
                SimpleDateFormat format1 = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss", Locale.FRANCE);
                newDate = format1.parse(DATUM.getStartedAt());
                format1 = new SimpleDateFormat("dd-MM-yyyy");
                timeFormat = new SimpleDateFormat("HH:mm:ss");
                String date1 = format1.format(newDate);
                String time1 = timeFormat.format(newDate);
                tvPickupDateTime.setText(date1 + " " + time1);
            }
        ...
        if (waypoint != null) {
            tvStopLocation.setText(DATUM.getDAddress());
            tvDropoffValue.setText(waypoint.getAddress());
        } else {
