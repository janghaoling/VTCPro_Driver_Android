...
import com.vtcpro.driver.BuildConfig;
import com.vtcpro.driver.MvpApplication;
import com.vtcpro.driver.R;
import com.vtcpro.driver.base.BaseActivity;
import com.vtcpro.driver.common.ChatHeadService;
import com.vtcpro.driver.common.Constants;
import com.vtcpro.driver.common.GPSTracker;
import com.vtcpro.driver.common.LocaleHelper;
import com.vtcpro.driver.common.PolyUtil;
import com.vtcpro.driver.common.SharedHelper;
import com.vtcpro.driver.common.Utilities;
import com.vtcpro.driver.common.chat.ChatActivity;
import com.vtcpro.driver.common.fcm.MyFireBaseMessagingService;
import com.vtcpro.driver.common.swipe_button.SwipeButton;
import com.vtcpro.driver.data.network.model.Advertisement;
import com.vtcpro.driver.data.network.model.LatLngFireBaseDB;
...
import com.vtcpro.driver.data.network.model.WayPoint;
import com.vtcpro.driver.ui.activity.add_card.AddCardActivity;
import com.vtcpro.driver.ui.activity.card.CardActivity;
import com.vtcpro.driver.ui.activity.currentride.CurrentRideActivity;
import com.vtcpro.driver.ui.activity.document.DocumentActivity;
import com.vtcpro.driver.ui.activity.earnings.EarningsActivity;
import com.vtcpro.driver.ui.activity.help.HelpActivity;
import com.vtcpro.driver.ui.activity.instant_ride.InstantRideActivity;
import com.vtcpro.driver.ui.activity.invite.InviteActivity;
import com.vtcpro.driver.ui.activity.invite_friend.InviteFriendActivity;
import com.vtcpro.driver.ui.activity.notification_manager.NotificationManagerActivity;
import com.vtcpro.driver.ui.activity.profile.ProfileActivity;
import com.vtcpro.driver.ui.activity.setting.SettingsActivity;
import com.vtcpro.driver.ui.activity.summary.SummaryActivity;
import com.vtcpro.driver.ui.activity.wallet.WalletActivity;
import com.vtcpro.driver.ui.activity.your_trips.YourTripActivity;
import com.vtcpro.driver.ui.adapter.AdsAdapter;
import com.vtcpro.driver.ui.bottomsheetdialog.invoice_flow.InvoiceDialogFragment;
import com.vtcpro.driver.ui.bottomsheetdialog.rating.RatingDialogFragment;
import com.vtcpro.driver.ui.fragment.incoming_request.IncomingRequestFragment;
import com.vtcpro.driver.ui.fragment.offline.OfflineFragment;
import com.vtcpro.driver.ui.fragment.status_flow.StatusFlowFragment;
...
import static com.vtcpro.driver.MvpApplication.DATUM;
import static com.vtcpro.driver.MvpApplication.DEFAULT_ZOOM;
import static com.vtcpro.driver.MvpApplication.PERMISSIONS_REQUEST_ACCESS_FINE_LOCATION;
import static com.vtcpro.driver.MvpApplication.canGoToChatScreen;
import static com.vtcpro.driver.MvpApplication.isChatScreenOpen;
import static com.vtcpro.driver.MvpApplication.mLastKnownLocation;
import static com.vtcpro.driver.common.Constants.checkStatus.ARRIVED;
import static com.vtcpro.driver.common.Constants.checkStatus.MIDSTOPPED;
import static com.vtcpro.driver.common.Constants.checkStatus.PICKEDUP;
import static com.vtcpro.driver.common.Constants.checkStatus.STARTED;
...
//        }
    ...
    private void openMap() {
        ...
        } else if (getString(R.string.drop_off_location).equalsIgnoreCase(lblLocationType.getText().toString())) {
            if (lblLocationName.getText().toString() != null) {
                Uri gmmIntentUri = Uri.parse("google.navigation:q=" + lblLocationName.getText().toString());
                Intent mapIntent = new Intent(Intent.ACTION_VIEW, gmmIntentUri);
                mapIntent.setPackage("com.google.android.apps.maps");
                startActivity(mapIntent);
            }
    ...
    private void openWaze() {
        ...
        if (getString(R.string.pick_up_location).equalsIgnoreCase(lblLocationType.getText().toString())) {
            ...
            address = lblLocationName.getText().toString();
        } else if (DATUM.getDAddress() != null && !DATUM.getDAddress().isEmpty()) {
        ...
        if (!STATUS.equalsIgnoreCase(status)) {
            ...
            switch (status) {
                ...
                case Constants.checkStatus.PICKEDUP:
                    ...
                    wayPointString = DATUM.getWay_points();
                    try {
