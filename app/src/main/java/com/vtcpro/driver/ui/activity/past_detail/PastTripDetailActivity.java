...
import com.vtcpro.driver.data.network.model.Payment;
import com.vtcpro.driver.data.network.model.Rating;
import com.vtcpro.driver.data.network.model.User_Past;
import com.vtcpro.driver.data.network.model.WayPoint;
import com.vtcpro.driver.ui.activity.zoom_view.ZoomPhotoActivity;
import com.vtcpro.driver.ui.bottomsheetdialog.invoice_show.InvoiceShowDialogFragment;
import com.vtcpro.driver.ui.fragment.dispute.DisputeCallBack;
import com.vtcpro.driver.ui.fragment.dispute.DisputeFragment;
import com.vtcpro.driver.ui.fragment.dispute_status.DisputeStatusFragment;
...
import static com.vtcpro.driver.MvpApplication.DATUM_history;
import static com.vtcpro.driver.MvpApplication.DATUM_history_detail;
...
public class PastTripDetailActivity extends BaseActivity implements PastTripDetailIView, DisputeCallBack {
    ...
    public void onSuccess(HistoryDetail historyDetail) {
        ...
        String wayPointString2 = historyDetail.getDestination_log();
        try {
            JSONArray ary = new JSONArray(wayPointString2);
            if (ary.length() > 0) {
                wayPoint2 = new WayPoint(ary.optJSONObject(0));
            }
        } catch (Exception e) {
            Log.d("tag", e.toString());
        }
        ...
        if (waypoint1 != null) {
            lblStop.setText(wayPoint2.getAddress() == null ? "" : wayPoint2.getAddress());
            lblDestination.setText(waypoint1.getAddress() == null ? "" : waypoint1.getAddress());
        } else {
