...
import static com.vtcpro.driver.MvpApplication.time_to_left;
...
//                SimpleDateFormat sdf = new SimpleDateFormat("hh:mm:ss");
        ...
        Log.d("111111111111111111", "Way point string::::" + wayPointString);

        if (waypoint != null) {
            lblStop.setText(data.getDAddress());
            lblDrop.setText(waypoint.getAddress());
        } else {
