...
import com.vtcpro.driver.base.BaseFragment;
...
import com.vtcpro.driver.data.network.model.Request_;
...
import com.vtcpro.driver.ui.activity.VoiceCall;
import com.vtcpro.driver.ui.activity.main.MainActivity;
import com.vtcpro.driver.ui.activity.zoom_view.ZoomPhotoActivity;
import com.vtcpro.driver.ui.bottomsheetdialog.cancel.CancelDialogFragment;
...
import static com.vtcpro.driver.common.Constants.User.Account.USER_TYPE_COMPANY;
...
//                }
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.imgCall:
                String name  = SharedHelper.getKey(this.getActivity(), Constants.SharedPref.USER_NAME);
                String[]  namelist = name.split(" ");
                mCompositeDisposable.add(APIClient
                        .getAPIClient()
                        .postChatItem("provider", String.valueOf(DATUM.getUserId()),   namelist[0] + " wants to call you!  Tap here to answer")
                        .subscribeOn(Schedulers.computation())
                        .observeOn(AndroidSchedulers.mainThread())
                        .subscribe(o -> System.out.println("RRR o = " + o)));

                Intent intent = new Intent(getContext(), VoiceCall.class);
    ...
    public void onWaitingTimeSuccess(TimerResponse object) {
        ...
        secondSplitUp(timerInHandler, tvTimer);
        if (object.getWaitingStatus() == 1) {
            btWaitingTime.setBackgroundResource(R.drawable.bg_waiting_time);
            customHandler.postDelayed(updateTimerThread, 1000);
        } else {
            btWaitingTime.setBackgroundResource(R.drawable.bg_waiting_unclicked);
